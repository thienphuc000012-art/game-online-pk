...
//			rigAI.linearVelocity = Vector2.zero;
//			rigAI.linearVelocity = new Vector2 (x, y);
...
//		rigAI.linearVelocity = Vector2.zero;
//		rigAI.linearVelocity = transform.position.x < playerScript.gameObject.transform.position.x ? new Vector2 (jumpX, jumpY) : new Vector2 (-jumpX, jumpY);
//	}
...
//			playerScript.rib.linearVelocity = new Vector2 (0, 20);
