...
//					rib.linearVelocity = transform.position.x < playerScript.gameObject.transform.position.x
...
//		isJumping = true;
//		rib.linearVelocity = Vector2.zero;
//		rib.linearVelocity = new Vector2 (velocityX, jumpSpeed);
//	}
...
//		if (transform.position.x > playerScript.gameObject.transform.position.x) {
//			transform.localScale = new Vector3 (-scaleX, scaleY, 0);
//			rib.linearVelocity = new Vector2 (velocityX, velocityY);
//		} else {
//			transform.localScale = new Vector3 (scaleX, scaleY, 0);
//			rib.linearVelocity = new Vector2 (-velocityX, velocityY);
//		}
